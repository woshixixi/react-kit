$(document).ready(function () {
    ...
    gbTurntable.init({
        ...
        getPrize: function (callback) {
            ...
            $('#mengban').show();
            $.ajax({
                url: 'https://beta-api.foroo.co.uk/api/v1/activitys/fortune_wheel',
                data: { free: firstTime },
                headers: { token: token },
    ...
    // 获取转盘页面结构
    $.ajax({
        url: 'https://beta-api.foroo.co.uk/api/v1/activitys',
    ...
    $('#backBtn').click(function () {
        // window.location.href = './sign_game.html' + window.location.search;
        window.history.back();
    });
