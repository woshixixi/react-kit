$(document).ready(function () {
    ...
    $('#model').addClass('none-class');
    $('#model').hide();
    $('#closeModel').addClass('none-class');
    $('#closeModel').hide();
    ...
    var targetElement = document.getElementById('modelBody');
    ...
    $('#rules').click(function () {
        ...
        $('#model').show();
        $('#closeModel').show();
        window.bodyScrollLock.lock(targetElement);
    });
    ...
    $('#closeModel').click(function () {
        ...
        $('#model').hide();
        $('#closeModel').hide();
        window.bodyScrollLock.unlock(targetElement);
    });
